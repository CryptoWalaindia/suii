    ...
    <div className="font-sans antialiased text-gray-800">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 glass-effect bg-white/80 backdrop-blur-lg shadow-lg animate-slide-down px-6 md:px-12 flex justify-between items-center">
        ...
        <nav className="hidden md:flex space-x-8">
          ...
          <a href="#waitlist" className="text-lg text-gray-600 hover:text-primary-500 font-medium transition-all duration-300 hover:scale-110">Waitlist</a>
        </nav>
        <a
          href="#waitlist"
      ...
      <main>
        ...
        >
          ...
          <div className="relative z-10 text-center md:text-left md:w-1/2 space-y-6 md:pr-12">
            <h1 className="text-5xl md:text-6xl font-extrabold leading-tight text-gray-900 animate-fade-in-up">
              Namaste India. Transact securely seamlessly with <span className="font-bold"><span className="text-blue-900">Crypto</span><span className="text-blue-400">Wala</span>.</span>
            </h1>
        ...
        <section id="about" className="py-20 px-6 md:px-12 bg-white">
          <div className="max-w-6xl mx-auto text-center">
            <h2 className="text-4xl font-bold text-gray-900 mb-12">About <span className="text-blue-900">Crypto</span><span className="text-blue-400">Wala</span></h2>
