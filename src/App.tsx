        ...
        >
          ...
          <div className="relative z-10 text-center md:text-left md:w-1/2 space-y-5 md:space-y-7 md:pr-12">
            ...
            <p className="text-base md:text-xl lg:text-2xl text-gray-300 leading-relaxed animate-fade-in-up delay-200 max-w-2xl">
              <span className="font-semibold text-blue-300">Bank-grade KYC verification</span> and <span className="font-semibold text-blue-300">competitive rates</span>, built for every Indian.
            </p>
              ...
              <div>
                <ul className="space-y-6">
                  ...
                  <li className="flex items-start space-x-3">
                    ...
                    <div>
                      <p className="text-lg text-gray-300 leading-relaxed">
                        <span className="font-semibold text-white">Regulatory compliance:</span> Fully registered and compliant with applicable regulations, ensuring a safe and trustworthy platform.
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start space-x-3">
